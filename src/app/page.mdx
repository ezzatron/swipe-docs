...
import Example from "../dynamic-code/Example";
...
You can highlight code that is generated dynamically. For example, you can take
an input and highlight code that changes based on the input.
