...
import Example from "../../composable/dynamic-code/Example";
...
You can highlight code that is generated dynamically. For example, you can
create a config generator with toggles for different options.
