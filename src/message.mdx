...
import loremIpsumTsAnnotationsDisabled from "./example/lorem-ipsum.ts?noAnnotations&code";
...
<details>
  ...
  <CodeBlock
    ...
    title="Code blocks"
  />
  <CodeBlock {...loremIpsumTsAnnotationsDisabled} title="Section annotations" />
</details>
